...
| 영역 | 기준 문서 | 상태 |
|---|---|---|
| 최상위 정책 | `book_writing.md` | 사용자 확정·금지·원고 잠금 유지 |
...
| 8부 적대·승리·비용 | `design/ARC-ANTAGONIST-VICTORY-COST-MATRIX-v1.md` | complete-candidate |
...
| 핵심 이름 감사 | `audit/NAMING-COLLISION-SEARCH-AUDIT-v1.md` + 병합 패키지 | complete-candidate |
| 지역·이동·계절·부상 | 병합 패키지 §4~5 | complete-candidate |
| 8부 화수·총분량 | 병합 패키지 §7 | 960화 중심값 산출 완료 |
...
- 작품 정체·입구·장기 욕망.
- 주인공·라이벌·사부·핵심 조연 장기선.
- 8부별 직접 목표·적대 구조·가짜 승리·진짜 승리·비용.
- 팔대신병 8개의 사용자·공동체·기능·대가·최종 처리.
...
- 라이벌: 소겸.
- 사부: 연소담, 보조 별호 선보.
- 조연: 양홍주, 진하, 곽무소, 두약란, 임도초, 위담, 문계서, 고유직, 석헌, 한백지.
- 가짜 문파: 반보문 / 반보회.
- 팔대신병 기록명·생활명 8쌍.
- 사건 지형 7개 코드.
